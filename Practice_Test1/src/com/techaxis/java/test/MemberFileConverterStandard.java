...
public abstract class MemberFileConverterStandard {
	/*
	 * NOTE: Do not modify this class
	 */
	protected abstract MemberExporter getMemberExporter( String fileType);
	...
	public void convert( File inputMemberFile, String outputFilePath, String outputFileName, String fileType ) throws Exception {
		...
		for ( Map.Entry< String, List< Member >> map: membersFilteredByState.entrySet( ) ) {
			...
			MemberExporter exporter = getMemberExporter(fileType );
